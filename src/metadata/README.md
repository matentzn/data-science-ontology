 ...
 * [dso.yml](dso.yml)
     * Determines how your purl.obolibrary.org/obo/dso/ redirects will be handled
     ...
     * Paste in the contents of [dso.yml](dso.yml)
 ...
 * [dso.md](dso.md)
     ...
     * Paste in the contents of [dso.md](dso.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
